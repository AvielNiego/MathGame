...
MathAction Exercise::generateRandomMathOperator()
{
	return MathAction(rand() % MATH_OPERATORS_COUNT);
}

Exercise* Exercise::generateExercise(int maximumNumber)
{
	...
	case PLUS:
		...
		return new Exercise(randNum1, randNum2, randNum1 + randNum2, varPosition, exerOperator);
	case MINUS:
		// varPosition can be 2 or 3
		varPosition = rand() % 2 + 2;
		return new Exercise(randNum2 + randNum1, randNum1, randNum2, varPosition, exerOperator);
	case MUL:
		varPosition = rand() % 2 + 1;
		return new Exercise(randNum1, randNum2, randNum1 * randNum2, varPosition, exerOperator);
	case DIV:
...
*/
bool Exercise::setVarPosition(int varPosition)
{
...
bool Exercise::validateVarPosition(int varPosition)
{
...
bool Exercise::insertNumber(int number)
{

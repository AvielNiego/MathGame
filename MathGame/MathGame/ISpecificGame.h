...
// ----           --------                -----------------
// 30/3/2015      Aviel Niego			  add virtual string getEndOfGameMessage()const = 0, virtual void setLevel(int startLevel) = 0;
//											  virtual int getMaxLevel()const = 0, virtual void redrawScreen()const = 0;
...
public:
	...
	virtual string getEndOfGameMessage()const = 0;
	virtual void setLevel(int startLevel) = 0;
	virtual int getMaxLevel()const = 0;
	virtual void redrawScreen()const = 0;
